...
if __name__ == "__main__" :
    ...
    evolutionary_control_rules.evolve_rules(viability_problem=vp, random_seed=44, n_initial_conditions=10, max_evaluations=100000, pop_size=100, offspring_size=200, saturate_control_function_on_boundaries=True, directory_name="3d-sphere")
